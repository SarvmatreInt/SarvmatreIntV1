...
const FAQ = () => {
  const DATA = [
    {
      ...
      content:
        `If you have any questions or inquiries, you can reach out to us through the "Contact Us" form on our website. You can also find our contact details, including number and email address, for direct communication.
        `,
    },
    {
      src: smile,
    ...
    {
      src: smile,
      title: "What information should I include in my message when using the contact form?",
      content:
  ...
  return (
    <div className="">
    <div className="max-w-[1440px] mx-auto min-[1440px]:mx-5">
