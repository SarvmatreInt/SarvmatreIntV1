...
import FeaturedJobs from "./CarrerPages/FeaturedJobs/FeaturedJobs";
      ...
      <ul className="grid gap-5 my-10 ">
        {careersData.length === 0 ? (
          ...
          careersData.map((data, index) => (
            <li
              className="flex flex-col gap-5 justify-between sm:flex-row w-[80%] mx-auto border-[1.5px] rounded-xl border-black p-5 sm:pr-10 hover:shadow-[4px_4px_rgba(0,0,0)] duration-[300ms] job-container cursor-pointer bg-[#caeeeb91]"
              key={index}
            >
