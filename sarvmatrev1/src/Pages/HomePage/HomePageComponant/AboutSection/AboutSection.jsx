        ...
        <div className="container">
          ...
          <div className="aboutHome flex flex-col lg:flex-row mt-36 mb-36 sm:gap-5 gap-11">
            <div className=" flex justify-center w-full" data-aos="fade-right">
              <img src={Me} data-aos="fade-right" alt="" className="max-w-full object-contain" />
            </div>
            <div className="about-homecontent flex flex-col flex-1 justify-center w-full mt-5 lg:mt-0" data-aos="fade-lef">
              <h3 className="text-3xl font-bold max-w-fit mb-3 py-3 px-5 rounded-md bg-[#2ea990] text-white">About us</h3>
              <h1 className="text-4xl xsm:text-5xl sm:text-6xl font-bold">{typedSuperPower}</h1>
