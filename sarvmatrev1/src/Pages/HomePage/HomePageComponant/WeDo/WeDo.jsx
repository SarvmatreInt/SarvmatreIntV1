...
const WeDo = () => {
  return (
    <div>
        <div className="">
            <div className=" py-36">
              <h1 className="text-6xl text-[#209089] text-center font-bold">WHAT WE DO </h1>
            </div>
            ...
            <div className=" relative my-20 mx-auto flex    ">
              ...
              <div className="relative flex sm:flex-row flex-col xl:gap-20 gap-5  ">
                {WhatWeDoAray.map((data, index) => (
                  ...
                  <div className={`  rounded-2xl shadow-md p-4 border flex-1   bg-[#F4F7E6] relative  ${data.className}`}>
                      <h3 className="text-5xl font-black pb-3 text-[#902027] ">{data.TitleNum}</h3>
